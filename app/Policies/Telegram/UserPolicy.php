...
use App\Models\User;
use App\Telegram\Models\User as TelegramUser;
...
final class UserPolicy
{
    ...
    {
        return $user->can('view_any_telegram_user');
    }
    ...
    {
        return $user->can('view_telegram_user');
    }
    ...
    {
        return $user->can('create_telegram_user');
    }
    ...
    {
        return $user->can('update_telegram_user');
    }
    ...
    {
        return $user->can('delete_telegram_user');
    }
    ...
    {
        return $user->can('delete_any_telegram_user');
    }
     ...
     */
    public function replicate(User $user, TelegramUser $telegramUser): bool
    {
